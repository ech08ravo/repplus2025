      ...
      tags$div(class = "sidebar-section",
        ...
        tags$div(class = "sidebar-content", style = "display: none;",
          ...
          checkboxInput("rgrid_zero_na",
                        tags$span("0 means \u201Cdoes not apply\u201D (Bezzi convention)",
                                  tags$br(),
                                  tags$small(class = "text-muted",
                                    tags$strong("Ticked:"), " 0 is not a rating - the construct does not apply to that element, as printed in Bezzi (1996). Ratings are read as 1-5.",
                                    tags$br(),
                                    tags$strong("Unticked (Rep Plus):"), " 0 is a real rating, the left pole. Rep Plus stores ratings 0-based, so the grid is shifted onto its declared scale.")),
                        value = FALSE),
